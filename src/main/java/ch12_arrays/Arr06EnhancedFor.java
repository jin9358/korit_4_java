...
/*
    ...
    일반 for문과의 차이점 :
        ...
        제약 :
            읽기가 되고, 쓰기가 안됩니다(예를 들어 1부터 100까지 추출하는 건 되는데, 1부터 100까지 입력은
            불가능할 때가 있습니다)
 ...
 */
public class Arr06EnhancedFor {
    public void printElem(String[] names) {
        // 향상된 for문의 형식으로 작성해보겠습니다.
        // for (자료형 변수명 : 반복가능객체(배열))
    ...
    public static void main(String[] args) {
        Arr06EnhancedFor arr06 = new Arr06EnhancedFor();
        ...
        arr06.printElem(names);
        System.out.println();
        arr06.printElem(numbers);
    }
}