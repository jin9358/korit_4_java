...
public class StrMap {
    public static void main(String[] args) {
        ...
        // 그래서 key값이 동일하다면 value값에는 최신 것으로 덮어쓰기 됩니다.
        ...
        boolean searchValueFalg1 = strmap1.containsValue("김삼");
        System.out.println("김삼 존재 여부 : " + searchValueFalg1);
...
//        List<Map<String, String>> entryList2 = strmap1.entrySet();    // Map -> List 대입이불가능하다는 걸 보여주는 예시
