...
public class JSON2 {
    public static void main(String[] args) {
        ...
        // user1 객체를 생성하고 "kim1", "9876", "a@test.com", "김일", "20"으로 입력하시오.
       ...
       // 그럼 생성된 user1 인스턴스를 가지고 Json 데이터로 바꿀겁니다.
        ...
        // JsonObject를 활용하여 studentCode 20250001 / studentName 김이 / studentyear 2 / score 96.7인 객체를 생성하시오.
        // 참고로 key value 다 String으로 잡아놓겠습니다.
        // JsonObject 클래스의 인스턴스 생성
        JsonObject jsonObject1 = new JsonObject();
        jsonObject1.addProperty("studentCode", "20250001");
        jsonObject1.addProperty("studnetName", "김이");
